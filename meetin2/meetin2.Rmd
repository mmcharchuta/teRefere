---
title: "Ćwiczenia z analizy danych w R"
author: "mmcharchuta"
date: "2025-04-08"
output:
...
# Exploratory visualization: Scatter plot with trend line
ggplot(tips, aes(x = total_bill, y = tip)) +
  geom_point(alpha = 0.6) +
  geom_smooth(method = "lm", se = FALSE, color = "blue") +
  labs(title = "Exploratory: Relationship Between Total Bill and Tip", x = "Total Bill", y = "Tip") +
  theme_minimal()
```

#### **Explanatory Visualization**
```{r explanatory_visualization, message=FALSE, warning=FALSE}
# Explanatory visualization: Annotated scatter plot
ggplot(tips, aes(x = total_bill, y = tip)) +
  geom_point(alpha = 0.6) +
  geom_smooth(method = "lm", se = FALSE, color = "blue") +
  annotate("text", x = 40, y = 8, label = "Higher bills tend to have higher tips", color = "red") +
  labs(title = "Explanatory: Total Bill vs Tip", x = "Total Bill", y = "Tip") +
  theme_minimal()
```
...
ggplot(tips, aes(x = total_bill, y = tip)) +
  ...
  geom_smooth(method = "lm", se = FALSE, color = "blue") +
  annotate("text", x = 40, y = 8, label = "Higher bills tend to have higher tips", color = "red") +
  labs(title = "Mixed: Total Bill vs Tip", x = "Total Bill", y = "Tip") +
  theme_minimal()
```